...
账号文件：`references/accounts_zh.txt`
...
2. 再读取 `references/filters_zh.md`（中文圈补充标准）。
...
放入可以马上尝试的工具、工作流、Prompt、教程、模板或方法步骤。中文圈额外侧重中文可用性和国内可访问性。

核心问题：看完以后，我能不能马上试一次？

#### 副业思路

放入能启发一人公司、产品切口、变现路径、获客方式或分发策略的内容。中文圈额外侧重低启动成本和国内内容生态适配。

核心问题：看完以后，我是不是更容易发现一个机会？

#### 认知探索

放入能改变对 AI、创作、工作方式、个人能力或长期选择理解的观点和框架。

核心问题：看完以后，我是不是更会判断了？

#### AI 趋势分析

放入模型能力、产品格局、平台规则、创作者生态、工具链或用户行为变化。中文圈侧重与国内工具链和创作者生态直接相关的变化。
...
产出路径：`output/creator-signal-digest/zh/YYYYMMDD_creator_signal_digest.md`
...
- 主题：`YYYYMMDD_本周创作者信号雷达（中文圈）`，例如 `20260605_本周创作者信号雷达（中文圈）`
